      ...
      <div className="w-4/5 mx-auto md:mx-0 md:w-1/3 flex flex-col items-center gap-8 md:gap-10 text-center pb-8 dark:text-slate-300">
        ...
        <div className="flex gap-5">
          <Link
            ...
            className="bg-green-600 px-5 py-2 rounded-3xl text-xs h-full my-auto text-white dark:text-slate-300 border border-green-600  hover:text-green-600 hover:bg-slate-200 dark:bg-slate-800 dark:border-none dark:hover:bg-slate-100 dark:hover:text-slate-800 lg:text-base "
          >
            Get Started
          </Link>
          <Link
